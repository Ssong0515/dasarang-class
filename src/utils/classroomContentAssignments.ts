import type { Classroom, LessonContent } from '../types';
...
export const getAssignedContentIdsForClassroom = (
  classroom: Pick<Classroom, 'assignedContentIds'>
): string[] => normalizeAssignedContentIds(classroom.assignedContentIds);
