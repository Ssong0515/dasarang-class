...
export interface Classroom {
  ...
  /**
   * '수업 복사해오기'로 이 반이 가져올 수 있는 원본 클래스들의 id 목록(강사가 반 설정에서 직접 고른다).
   * 대시보드 복사 후보 = 여기 담긴 클래스들의 수업 기록. 비면 복사 후보가 없다. 방향성 있음(이 반이 고른 클래스에서만 가져옴).
   */
  copyFromClassroomIds?: string[];
  /**
